...
RegisterNetEvent("ValoriaAC:allowToOpen")
AddEventHandler("ValoriaAC:allowToOpen", function()
    isAdmin = true
end)

-- Event: Receive player data for the admin menu
RegisterNetEvent("ValoriaAC:sendAllPlayerData")
AddEventHandler("ValoriaAC:sendAllPlayerData", function(playerList)
    updatePlayerList(playerList)
end)

-- Event: Open player data menu in the admin UI
RegisterNetEvent("ValoriaAC:openPlayerData")
AddEventHandler("ValoriaAC:openPlayerData", function(data)
    openPlayerAction(data)
end)

-- Event: Spectate a player
RegisterNetEvent("ValoriaAC:spectatePlayer")
AddEventHandler("ValoriaAC:spectatePlayer", function(target, coords)
...
RegisterNetEvent("ValoriaAC:updateBanListData")
AddEventHandler("ValoriaAC:updateBanListData", function(banList)
    updateBanListData(banList)
end)

-- Event: Update admin data
RegisterNetEvent("ValoriaAC:updateAdminData")
AddEventHandler("ValoriaAC:updateAdminData", function(adminList)
    updateAdminData(adminList)
end)

-- Event: Update unban access data
RegisterNetEvent("ValoriaAC:updateUnbanAccess")
AddEventHandler("ValoriaAC:updateUnbanAccess", function(unbanList)
    updateUnbanAccess(unbanList)
end)

-- Event: Update whitelist data
RegisterNetEvent("ValoriaAC:updateWhiteList")
AddEventHandler("ValoriaAC:updateWhiteList", function(whiteList)
...
RegisterCommand("valoriaacmenu", function()
    if isAdmin then
        openAdminMenu()
    end
end, false)
...
RegisterKeyMapping("valoriaacmenu", "ValoriaAC admin menu", "keyboard", ValoriaAC.AdminMenu.Key)
...
RegisterNUICallback("getAllPlayersData", function(data, cb)
    TriggerServerEvent("ValoriaAC:getAllPlayerData")
    cb("ok")
end)

-- Callback: Get player data
RegisterNUICallback("getPlayerData", function(data, cb)
    TriggerServerEvent("ValoriaAC:getPlayerData", data.playerId)
    cb("ok")
end)
...
RegisterNUICallback("spectate", function(data, cb)
    if InSpectatorMode then
        ...
        TriggerServerEvent('ValoriaAC:requestSpectate', data.playerId)
    end
    cb("ok")
end)
...
RegisterNUICallback("spawnVehicleForSelf", function(data, cb)
    TriggerServerEvent("ValoriaAC:spawnVehicle", data)
    cb("ok")
end)
...
RegisterNUICallback("getUnbanAccessData", function(data, cb)
    ...
    TriggerServerEvent("ValoriaAC:getUnbanAccessData")
    cb("ok")
end)
...
RegisterNUICallback("removeUnbanAccess", function(data, cb)
    ...
    TriggerServerEvent("ValoriaAC:removeUnbanAccess", data.id)
    cb("ok")
end)
...
RegisterNUICallback("getWhitelistData", function(data, cb)
    ...
    TriggerServerEvent("ValoriaAC:getWhitelistData")
    cb("ok")
end)
...
RegisterNUICallback("removeWhitelistUser", function(data, cb)
    ...
    TriggerServerEvent("ValoriaAC:removeWhitelistUser", data.id)
    cb("ok")
end)
